...
export function ProductDialog({ trigger, onProductAdded }: ProductDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    productFormData.append('collectionId', sanitizedData.collection) // Backend expects collectionId
    ...
    try {
      console.log('Creating product with FormData:', {
        ...
        collectionId: sanitizedData.collection,
      ...
      if (response.success || response.status === 201) {
        ...
        const errorMessage = response.message || response.error || "خطا در ایجاد محصول"
      ...
      let errorMessage = error.message || "خطا در ایجاد محصول"
